...
if(bulletj=='-' && ((space[jy][jx-1]!=player3)||(space[jy][jx-2]!=player3)||(space[jy][jx-1]!=')')||(space[jy][jx-2]!=')')||(space[jy][jx-1]!='}')||(space[jy][jx-2]!='}') ))
        {
            space[jy][jx]=' ';
            jx--;
            jx--;
...
//KKKKKKKKK
        if(bulletk=='-' && ((space[ky][kx-1]!=player3)||(space[ky][kx-2]!=player3)||(space[ky][kx-1]!=')')||(space[ky][kx-2]!=')')||(space[ky][kx-1]!='}')||(space[ky][kx-2]!='}') ))
        {
            space[ky][kx]=' ';
            kx--;
            kx--;
...
//LLLLLLLLLL
if(bulletl=='-' && ((space[ly][lx-1]!=player3)||(space[ly][lx-2]!=player3)||(space[ly][lx-1]!=')')||(space[ly][lx-2]!=')')||(space[ly][lx-1]!='}')||(space[ly][lx-2]!='}') ))
        {
            space[ly][lx]=' ';
            lx--;
            lx--;
...
//MMMMMMMMMMMM
if(bulletm=='-' && ((space[my][mx-1]!=player3)||(space[my][mx-2]!=player3)||(space[my][mx-1]!=')')||(space[my][mx-2]!=')')||(space[my][mx-1]!='}')||(space[my][mx-2]!='}') ))
        {
            space[my][mx]=' ';
            mx--;
            mx--;
...
//NNNNNNNNNNNNN
if(bulletn=='-' && ((space[ny][nx-1]!=player3)||(space[ny][nx-2]!=player3)||(space[ny][nx-1]!=')')||(space[ny][nx-2]!=')')||(space[ny][nx-1]!='}')||(space[ny][nx-2]!='}') ))
        {
            space[ny][nx]=' ';
            nx--;
            nx--;
...
//OOOOOOOOOOO
if(bulleto=='-' && ((space[oy][ox-1]!=player3)||(space[oy][ox-2]!=player3)||(space[oy][ox-1]!=')')||(space[oy][ox-2]!=')')||(space[oy][ox-1]!='}')||(space[oy][ox-2]!='}') ))
        {
            space[oy][ox]=' ';
            ox--;
            ox--;
...
//PPPPPPPPPPP
if(bulletp=='-' && ((space[py][px-1]!=player3)||(space[py][px-2]!=player3)||(space[py][px-1]!=')')||(space[py][px-2]!=')')||(space[py][px-1]!='}')||(space[py][px-2]!='}') ))
        {
            space[py][px]=' ';
            px--;
            px--;
...
//QQQQQQQQQQQQ
if(bulletq=='-' && ((space[qy][qx-1]!=player3)||(space[qy][qx-2]!=player3)||(space[qy][qx-1]!=')')||(space[qy][qx-2]!=')')||(space[qy][qx-1]!='}')||(space[qy][qx-2]!='}') ))
        {
            space[qy][qx]=' ';
            qx--;
            qx--;
...
//RRRRRRRRRRRRRRRRR
if(bulletr=='-' && ((space[ry][rx-1]!=player3)||(space[ry][rx-2]!=player3)||(space[ry][rx-1]!=')')||(space[ry][rx-2]!=')')||(space[ry][rx-1]!='}')||(space[ry][rx-2]!='}') ))
        {
            space[ry][rx]=' ';
            rx--;
            rx--;
...
//SSSSSSSSSSSSS
if(bullets=='-' && ((space[sy][sx-1]!=player3)||(space[sy][sx-2]!=player3)||(space[sy][sx-1]!=')')||(space[sy][sx-2]!=')')||(space[sy][sx-1]!='}')||(space[sy][sx-2]!='}') ))
        {
            space[sy][sx]=' ';
            sx--;
            sx--;
...
//y
if(milliseconds==4 || milliseconds==8 || milliseconds==12)
{
...
int randNumb=rand()%2+1;
//y
if(milliseconds==2 || milliseconds==6 || milliseconds==10)
{
    if(randNumb==1 && enemy2sprite=='(' && enemy2x>3)
    {
        if(enemy2y>=1){
        space[enemy2y][enemy2x]=' ';
        enemy2y--;}
    }
    if(randNumb==2 && enemy2sprite=='('&& enemy2x>3)
        {
            if(enemy2y<height-2)
            {
            space[enemy2y][enemy2x]=' ';

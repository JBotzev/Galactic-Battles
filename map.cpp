...
if(bulletj=='-' && ((space[jy][jx-1]!=player)||(space[jy][jx-2]!=player)||(space[jy][jx-1]!=')')||(space[jy][jx-2]!=')')||(space[jy][jx-1]!='}')||(space[jy][jx-2]!='}') ))
        {
            space[jy][jx]=' ';
            jx--;
            jx--;
...
//KKKKKKKKK
        if(bulletk=='-' && ((space[ky][kx-1]!=player)||(space[ky][kx-2]!=player)||(space[ky][kx-1]!=')')||(space[ky][kx-2]!=')')||(space[ky][kx-1]!='}')||(space[ky][kx-2]!='}') ))
        {
            space[ky][kx]=' ';
            kx--;
            kx--;
...
//LLLLLLLLLL
if(bulletl=='-' && ((space[ly][lx-1]!=player)||(space[ly][lx-2]!=player)||(space[ly][lx-1]!=')')||(space[ly][lx-2]!=')')||(space[ly][lx-1]!='}')||(space[ly][lx-2]!='}') ))
        {
            space[ly][lx]=' ';
            lx--;
            lx--;
...
//MMMMMMMMMMMM
if(bulletm=='-' && ((space[my][mx-1]!=player)||(space[my][mx-2]!=player)||(space[my][mx-1]!=')')||(space[my][mx-2]!=')')||(space[my][mx-1]!='}')||(space[my][mx-2]!='}') ))
        {
            space[my][mx]=' ';
            mx--;
            mx--;
...
//NNNNNNNNNNNNN
if(bulletn=='-' && ((space[ny][nx-1]!=player)||(space[ny][nx-2]!=player)||(space[ny][nx-1]!=')')||(space[ny][nx-2]!=')')||(space[ny][nx-1]!='}')||(space[ny][nx-2]!='}') ))
        {
            space[ny][nx]=' ';
            nx--;
            nx--;
...
//OOOOOOOOOOO
if(bulleto=='-' && ((space[oy][ox-1]!=player)||(space[oy][ox-2]!=player)||(space[oy][ox-1]!=')')||(space[oy][ox-2]!=')')||(space[oy][ox-1]!='}')||(space[oy][ox-2]!='}') ))
        {
            space[oy][ox]=' ';
            ox--;
            ox--;
...
//PPPPPPPPPPP
if(bulletp=='-' && ((space[py][px-1]!=player)||(space[py][px-2]!=player)||(space[py][px-1]!=')')||(space[py][px-2]!=')')||(space[py][px-1]!='}')||(space[py][px-2]!='}') ))
        {
            space[py][px]=' ';
            px--;
            px--;
...
//QQQQQQQQQQQQ
if(bulletq=='-' && ((space[qy][qx-1]!=player)||(space[qy][qx-2]!=player)||(space[qy][qx-1]!=')')||(space[qy][qx-2]!=')')||(space[qy][qx-1]!='}')||(space[qy][qx-2]!='}') ))
        {
            space[qy][qx]=' ';
            qx--;
            qx--;
...
//RRRRRRRRRRRRRRRRR
if(bulletr=='-' && ((space[ry][rx-1]!=player)||(space[ry][rx-2]!=player)||(space[ry][rx-1]!=')')||(space[ry][rx-2]!=')')||(space[ry][rx-1]!='}')||(space[ry][rx-2]!='}') ))
        {
            space[ry][rx]=' ';
            rx--;
            rx--;
...
//SSSSSSSSSSSSS
if(bullets=='-' && ((space[sy][sx-1]!=player)||(space[sy][sx-2]!=player)||(space[sy][sx-1]!=')')||(space[sy][sx-2]!=')')||(space[sy][sx-1]!='}')||(space[sy][sx-2]!='}') ))
        {
            space[sy][sx]=' ';
            sx--;
            sx--;
...
int randrespawna=rand()%21+2;
int randrespawnb=rand()%21+2;
if(enemy1sprite==' ' && enemy2sprite==' ')
{
    space[enemy1y][enemy1x]=' ';space[enemy2y][enemy2x]=' ';
enemy1x=75;
enemy1y=randrespawna;
enemy2x=77;
enemy2y=randrespawnb;
enemy1sprite='<';
enemy2sprite='(';
ia=1;
}
...
if(start==1)
{
    PlaySound(TEXT("250856__joshuaempyre__epic-orchestra-loop.wav"),NULL,SND_ASYNC);
    Sleep(1000);
    start=0;
}
}
